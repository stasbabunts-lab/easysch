...
export function inviteMessage(code: string) {
  return (
    `Підключіться до бота, щоб отримувати нагадування про заняття та реквізити для оплат:\n` +
...
export function StudentInviteBody({ code }: { code: string }) {
...
export function StudentInviteButton({ name, code }: { name: string; code: string }) {
